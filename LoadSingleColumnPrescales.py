...
# LoadPrescales.py
# Script for loading prescales into ConfDB
# 
# 
...
def main(argv):
    ...
    confdbjob = LoadSingleColumnPrescales()
    confdbjob.BeginJob()

class LoadSingleColumnPrescales:
    def __init__(self):

        self.dbname = "CMS_ORCOFF_PROD"
        self.dbuser = "CMS_HLTDEV"
        self.dbpwd = "cms100kHz"
        self.dbhost = "CMS_ORCOFF_PROD"
        self.verbose = 1
        self.cmsswrel = "CMSSW_5_2_3_HLT5"
        self.configname = "/users/jjhollar/ForPrescaleUploads/CMSSW_5_2_3_HLT6_Master_V180/V1"
        self.prescalefile = "prescales7E33.txt"
        self.cliupdate = 0
        self.addtorelease = ""
    ...
    def BeginJob(self):
        ...
        for prescaleline in prescalelines:
            ...
            print self.newhltprescaledict[trigger]
